...
archsalida <- "C:/Users/felip/OneDrive/Documentos/TUPED/3erAño/Mineria/Datos/TetuanCityPowerConsumption.csv"
...
datos <- tabla[[1]]
# Guardamos los datos
fwrite(datos, "C:/Users/felip/OneDrive/Documentos/TUPED/3erAño/Mineria/Datos/SuperBowlNFL.csv",
       sep = ";")
